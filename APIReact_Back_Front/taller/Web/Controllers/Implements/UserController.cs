...
namespace Web.Controllers.Implements
{
    ...
    public class UsersController : BaseController<UserDto, IUserService>
    {
        public UsersController(IUserService service, ILogger<UsersController> logger)
            : base(service, logger) { }

        protected override Task<IEnumerable<UserDto>> GetAllAsync(GetAllType g) => _service.GetAllAsync(g);

        protected override Task<UserDto?> GetByIdAsync(int id) => _service.GetByIdAsync(id);
