...
namespace Web.Controllers.Implements
{
    ...
    public class FormModuleController : BaseController<FormModuleDto, IFormModuleService>
    {
        public FormModuleController(IFormModuleService service, ILogger<FormModuleController> logger) : base(service, logger)
        {
        }

        protected override Task<IEnumerable<FormModuleDto>> GetAllAsync(GetAllType getAllType)=> _service.GetAllAsync(getAllType);
        protected override Task<FormModuleDto?> GetByIdAsync(int id) => _service.GetByIdAsync(id);
