...
namespace Web.Controllers.Implements
{
    ...
    public class PersonController : BaseController<PersonDto, IPersonService>
    {
        ...
        protected override Task<IEnumerable<PersonDto>> GetAllAsync(GetAllType getAllType) => _service.GetAllAsync(getAllType);
        protected override Task<PersonDto?> GetByIdAsync(int id) => _service.GetByIdAsync(id);
