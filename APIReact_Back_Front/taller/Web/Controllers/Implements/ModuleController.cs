...
namespace Web.Controllers.Implements
{
    ...
    public class ModuleController : BaseController<ModuleDto, IModuleService>
    {
        ...
        protected override Task<IEnumerable<ModuleDto>> GetAllAsync(GetAllType getAllType) => _service.GetAllAsync(getAllType);

        protected override Task<ModuleDto?> GetByIdAsync(int id)=> _service.GetByIdAsync(id);
