...
namespace Web.Controllers.Implements
{
    ...
    public class PermissionController : BaseController<PermissionDto, IPermissionService>
    {
        ...
        protected override Task<IEnumerable<PermissionDto>> GetAllAsync(GetAllType getAllType) => _service.GetAllAsync(getAllType);

        protected override Task<PermissionDto?> GetByIdAsync(int id) => _service.GetByIdAsync(id);
