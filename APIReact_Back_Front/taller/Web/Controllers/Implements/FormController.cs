...
namespace Web.Controllers.Implements
{
    ...
    public class FormController : BaseController<FormDto, IFormService>
    {
        public FormController(IFormService service, ILogger<FormController> logger) : base(service, logger)
        {
        }

        protected override Task<IEnumerable<FormDto>> GetAllAsync(GetAllType g)
        {
            return _service.GetAllAsync(g);
        }
        protected override Task<FormDto?> GetByIdAsync(int id)
        {
