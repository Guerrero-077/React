...
namespace Web.Controllers.Implements
{
    ...
    public class RolController : BaseController<RolDto, IBusiness<RolDto>>
    {
        public RolController(IBusiness<RolDto> service, ILogger<RolController> logger)
            : base(service, logger) { }

        protected override async Task<IEnumerable<RolDto>> GetAllAsync(GetAllType g)
        {
        ...
        protected override Task<RolDto?> GetByIdAsync(int id) =>_service.GetByIdAsync(id);
