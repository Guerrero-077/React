...
{
    public class FormModuleService : BusinessBasic<FormModuleDto,FormModule>, IFormModuleService
    {
        ...
        public override async Task<IEnumerable<FormModuleDto>> GetAllAsync(GetAllType getAllType)
        {
            try
            {
        ...
        public override async Task<FormModuleDto?> GetByIdAsync(int id)
        {
            try
            {
