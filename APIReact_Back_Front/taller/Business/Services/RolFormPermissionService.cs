...
{
    public class RolFormPermissionService : BusinessBasic<RolFormPermissionDto, RolFormPermission>, IRolFormPermissionService
    {
        ...
        public override async Task<IEnumerable<RolFormPermissionDto>> GetAllAsync(GetAllType getAllType)
        {
            try
            {
        ...
        public override async Task<RolFormPermissionDto?> GetByIdAsync(int id)
        {
            try
            {
